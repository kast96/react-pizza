...
import { ItemsCartType, minusItem, plusItem, removeItem } from '../redux/slices/cartSlice'

export const CartItem: FC<ItemsCartType> = ({id, title, price, imageUrl, size, type, count}) => {
